...
from geogeniustools2.rda.env_variable import PUBLIC_RDA_ENDPOINT
...
class PlotMixin(object):
    ...
    def histogram_match(self, use_bands, blm_source=None, **kwargs):
        ...
        if blm_source == 'browse':
            from geogeniustools2.images.browse_image import BrowseImage
            ref = BrowseImage(self.cat_id, bbox=bounds).read()
        else:
            from geogeniustools2.images.tms_image import TmsImage
